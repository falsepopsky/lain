import { MobileBrowse, MobileFake, browse, browseQuery, browseQueryPageTen, fake } from '../fixtures/index.js';
import { getPages, getTitles, getTitlesMobile } from '../src/index.js';
